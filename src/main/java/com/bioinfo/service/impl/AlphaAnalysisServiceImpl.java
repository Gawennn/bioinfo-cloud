...
@Slf4j
@Service
public class AlphaAnalysisServiceImpl implements AlphaAnalysisService {
    ...
    public Object analyze(Long fileId) {
        ...
        try {
            ...
            task.setTaskName("alpha多样性分析");


            Long price = itemMapper.getPriceByName("alpha多样性分析");
    ...
    private Path getResultPath (Task task, Long userId){
        String fileName = task.getFileName().replace(".xlsx", "_alpha_result.xlsx");
